...
describe('Log View Provider Logic', function () {
  ...
  describe('Storage Integration', function () {
    it('should retrieve all requests from storage', async function () {
    ...
    it('should retrieve request by ID', async function () {
    ...
    it('should delete request by ID', async function () {
      const request = createMockRequest();
      await storage.saveRequest(request);
    ...
    it('should check if requests exist', async function () {
  ...
  describe('Request Sorting', function () {
    it('should sort requests by timestamp (newest first)', async function () {
  ...
  describe('Label Formatting', function () {
    ...
    it('should create proper request label format', function () {
      const request = createMockRequest();
